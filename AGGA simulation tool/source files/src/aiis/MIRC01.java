...
public class _StructureGroup extends Group {
  ...
  public void setup() {
    ...
    _shape_textBox_13.setText( "Статистика\n" );
    ...
    _shape_textBox1_31.setText( "Системные переменные\n" );
    ...
    _shape_textBox2_32.setText( "Вспомогательные переменные" );
...
class Type_oprosAlgoritm extends Statechart {
  ...
  public static final short Та_м_ау_______а2 = 52;
  public static final short Та_м_ау_______а1 = 53;
  public static final short Та_м_ау_______а = 54;
  public static final short п__GPRS = 55;
  public static final short п__GSM = 56;
  public static final short Счё_чи_________ча__ = 57;
  public static final short Е_ё_ма__и_ = 58;
  public static final short Сл_д__парам__р = 59;
  public static final short Сл_д__ма__и_ = 60;
  public static final short О____ = 61;
  public static final short Запр__ = 62;
  public static final short Жур_ал______и_ = 63;
  public static final short ___рги__за__у__и = 64;
  public static final short Ср_з__м______и = 65;
  public static final short Д_п__парам__р_ = 66;
  public static final short За_р__и____а__а_______ = 67;
  public static final short За_р__и____а__а_запр___ = 68;
  public static final short О__р__и____а__а_______ = 69;
  public static final short Опр___парам__р__ = 70;
  public static final short О__р__и____а__а_запр___ = 71;
  public static final short _______пр__а_i_г__C_Т = 72;
  public static final short В____м__а_ал__МИР______ = 73;
  public static final short О_ида_и_ = 74;
  public static final short Начал_ = 75;
  public static final short За___ч____пр___МИР__ = 76;
  ...
  protected Node[] getNodes() { return new Node[]{
    ...
    new Node( 326, eState, "Тайм-аут ответа2", -1 ),
    new Node( 324, eState, "Тайм-аут ответа1", -1 ),
    new Node( 322, eState, "Тайм-аут ответа", -1 ),
    new Node( 315, eState, "по GPRS", -1 ),
    new Node( 313, eState, "по GSM", -1 ),
    new Node( 301, eState, "Счётчик не отвечает", -1 ),
    new Node( 302, eState, "Ещё массив", -1 ),
    new Node( 303, eState, "След. параметр", -1 ),
    new Node( 305, eState, "След. массив", -1 ),
    new Node( 307, eState, "Ответ", -1 ),
    new Node( 308, eState, "Запрос", -1 ),
    new Node( 275, eState, "Журнал событий", -1 ),
    new Node( 276, eState, "Энергия за сутки", -1 ),
    new Node( 277, eState, "Срезы мощности", -1 ),
    new Node( 278, eState, "Доп. параметры", -1 ),
    new Node( 234, eState, "Закрытие сеанса(ответ)", -1 ),
    new Node( 235, eState, "Закрытие сеанса(запрос)", -1 ),
    new Node( 247, eState, "Открытие сеанса(ответ)", -1 ),
    new Node( 255, eState, "Опрос параметров", -1 ),
    new Node( 256, eState, "Открытие сеанса(запрос)", -1 ),
    new Node( 257, eState, "Конец опроса i-го CЭТ", -1 ),
    new Node( 15, eState, "В этом канале МИРов нет", -1 ),
    new Node( 16, eState, "Ожидание", -1 ),
    new Node( 19, eState, "Начало", -1 ),
    new Node( 14, eState, "Закончен опрос МИРов", -1 ),
  }; }
