...
public class cfgSystem extends JDialog {
 ...
 public String msgYesNo = "Удалить GSM(Да) или GPRS(Нет) канал?";
 public String msgNoGSM = "Канал GSM отсутствует!";
 public String msgNoGPRS = "Канал GPRS отсутствует!";

 public String msg = "Введите данные: тип канала и кол-во счётчиков!";
 public String alert = "Внимание!!!";
 public String msgError = "Внимание!!!";
...
public cfgSystem(Frame frame, String title, boolean modal) {
 ...
 // ex.printStackTrace();
  ...
  public void jbInit() throws Exception {
    ...
    imageDeleteI = new ImageIcon(interfaceMod.Frame1.class.getResource(
        "deleteI.png"));
    imageExitWin = new ImageIcon(interfaceMod.Frame1.class.getResource(
        "exitWin.png"));
    imageDeleteAll = new ImageIcon(interfaceMod.Frame1.class.getResource(
        "deleteAll.png"));
    imageCreate = new ImageIcon(interfaceMod.Frame1.class.getResource(
        "create.png"));
    contentPane = (JPanel)this.getContentPane();
    border1 = BorderFactory.createEtchedBorder(Color.white,
                                               new Color(165, 161, 133));
...
void deleteGSM(){
  ...
  { JOptionPane.showMessageDialog(this,msgNoGSM,msgError,JOptionPane.ERROR_MESSAGE);
  }
  ...
  { JOptionPane.showMessageDialog(this,msgNoGPRS,msgError,JOptionPane.ERROR_MESSAGE);
  }
...
aiis.model.askChannel.set(0,1,1);
 ...
 aiis.model.askChannel.set(0,2,1);
  ...
  int whatChannel = JOptionPane.showConfirmDialog(this,msgYesNo,alert,JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE);
  switch(whatChannel){
