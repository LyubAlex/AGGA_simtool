...
public class dcfgMod extends JDialog {
  ...
  Object[] dataInterval = {new String("Раз в сутки"),
                           new String("60 минут"),
                           new String("30 минут"),
                           new String("15 минут"),
                           new String("5 минут"),
  ...
  private void jbInit() throws Exception {
    ...
    border3 = new TitledBorder(BorderFactory.createEtchedBorder(Color.white,new Color(165, 163, 151)),"Параметры счётчиков");
