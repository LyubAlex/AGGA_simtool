...
public class dcfgMod extends JDialog {
  ...
  private void jbInit() throws Exception {
    ...
    titledBorder1 = new TitledBorder(border1,"Set parameters");
    border2 = BorderFactory.createEtchedBorder(Color.white,new Color(147, 178, 165));
    titledBorder2 = new TitledBorder(BorderFactory.createEtchedBorder(Color.white,new Color(165, 163, 151)),"Requested parameters");
    ...
    labelVrMod.setText("Simulation time, days");
