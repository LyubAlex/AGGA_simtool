...
public cfgSystem() {
 ...
 // ex.printStackTrace();
  ...
  public void jbInit() throws Exception {
    titledBorder1 = new TitledBorder(BorderFactory.createEtchedBorder(Color.white,new Color(165, 163, 151)),"Structure of the system");
    imageCreate = new ImageIcon(interfaceMod.cfgSystem.class.getResource("create.png"));
    imageDeleteI = new ImageIcon(interfaceMod.cfgSystem.class.getResource("deleteI.png")); 
    imageExitWin = new ImageIcon(interfaceMod.cfgSystem.class.getResource("exitWin.png"));
    imageDeleteAll = new ImageIcon(interfaceMod.cfgSystem.class.getResource("deleteAll.png"));
    ...
    contentPane.setPreferredSize(new Dimension(254, 231));
     ...
     titledBorder1.setTitle("System configuration");
     jLabelTypeChannel.setFont(new java.awt.Font("Arial", 0, 11));
     jLabelTypeChannel.setText("Channel type:");
  
     jLabelTypeCh.setText("Counters type and quantity:");
     jLabelTypeCh.setFont(new java.awt.Font("Arial", 0, 11));
     jLabelSET.setText("SET-4ÒÌ");
     ...
     inputKolSET.setHorizontalAlignment(SwingConstants.CENTER);
      ...
      createChannel.setToolTipText("Create channel");
    ...
    jLabelitogo.setText("All channels:");
    ...
    jLabelMIR.setText("MIR-Ñ01");
    bResetiChannel.setEnabled(false);
    bResetiChannel.setToolTipText("Cancel the last input");
    ...
    bResetAllChannel.setToolTipText("Reset the configuration");
...
void deleteGSM(){
  ...
  { JOptionPane.showMessageDialog(this,"There is no any GSM channel!","Error!",JOptionPane.ERROR_MESSAGE);
  }
  ...
  { JOptionPane.showMessageDialog(this,"There is no any GPRS channel!","Error!",JOptionPane.ERROR_MESSAGE);
  }
...
{JOptionPane.showMessageDialog(this,"Specify channel type and counters number!","Attention!",JOptionPane.WARNING_MESSAGE);}
else{
     if (flGSM.getState()){
...
{flGSM.setEnabled(false);
  ...
  int whatChannel = JOptionPane.showConfirmDialog(this,"Delete GSM(Yes) or GPRS(No) channel?","Attention!",JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE);
  switch(whatChannel){
